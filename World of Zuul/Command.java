 ...
 * word and a third word (for example, if the command was "translate ja danke", 
 * then the three strings obviously are "translate","ja" and "danke").
 * 
...
public class Command
{
    ...
    {
        // intialisation of all the fields:
